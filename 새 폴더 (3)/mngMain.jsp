...
<body>
<% //로그인이 된 사람은 이 메인페이지에서 로그인 정보를 담을 수 있게 해준다
    String managerID = null; // 로그인이 된 사람들은 로그인정보를 담을 수 있도록한다
    if (session.getAttribute("managerID") != null)//이 세션을 유지하는 사람이라면 이 아이디 값을 받아서 관리할 수 있게 해줌
    {
    	managerID = (String)session.getAttribute("managerID");//형 변환으로 세션 값을 그대로 받아올 수 있게  
      //로그인을 한 사람이라면 유저아이디에 해당 아이디가 담길 것이고 로그인을 안 했으면 null값에 담기게 됨
    }
...
%>
    <nav class ="navbar navbar-default">
        <div class="navbar-header"> <!-- 홈페이지의 로고 -->
            ...
            <a class ="navbar-brand" href="main.jsp">JSP 관리자 게시판 웹 사이트</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <a href="#" class = "dropdown-toggle"
                    ...
                    <ul class="dropdown-menu">
                       <li><a href="logoutAction.jsp">로그아웃</a></li>
                       <li><a href="mngMain.jsp">상품 등록</a></li>
                       <li><a href="mngMain.jsp">내정보</a></li>
                    </ul>
                </li>
            </ul>
       <%
